...
const DEMO_CONTA = {cpf:"00000000000",nome:"Oryx Internet Ltda",contratos:[
  {contratoId:"101",clienteId:"77",plano:"700 MEGA ORYX BÁSICO NOVO",status:"Ativo",vencimento:25,valorAberto:"119,90",titulos:1,pendencia:true,cidade:"Brasília"},
  {contratoId:"58",clienteId:"77",plano:"700 MEGA ORYX BÁSICO",status:"Ativo",vencimento:10,valorAberto:null,titulos:0,pendencia:false,cidade:"Brasília"},
]};
const DEMO_BOLETOS = [
...
export default function App(){
  ...
  const mkCliente=(a,ct)=>({cpf:a.cpf,nome:a.nome,contratoId:ct.contratoId,clienteId:ct.clienteId,plano:ct.plano||"Internet",status:ct.status||"Ativo",vencimento:ct.vencimento||null,valorAberto:ct.valorAberto||null,titulos:ct.titulos||0,pendencia:!!ct.pendencia});
